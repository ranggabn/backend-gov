...
module.exports = function (app) {
  ...
  var jsonForgot = require("../controllers/forgotPasswordController");
  ...
  app.route("/checkToken").get(jsonForgot.checkToken);
